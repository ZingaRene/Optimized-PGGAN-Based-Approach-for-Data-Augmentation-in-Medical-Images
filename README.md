...
<tr>
<td colspan="2" align="center">
<img src="images/Data Images/CXR/Pneumonia_Normal.png" height="270">
</td>
</tr>
...
### 7.1. Training the Densenet121 Model
...
### 7.3. Training Process of the PGGAN Model

<tr>
<td colspan="2" align="center">
<img src="images/PGGANs_Training_Process.png" height="270">
</td>
</tr>
...
#### 7.5.1 The FID result
<tr>
<td colspan="2" align="center">
<img src="images/FID_Comparison.png" height="270">
</td>
</tr>
...
The results from the cross-validation and test set evaluations will provide insights into the performance improvements achieved by using synthetic images generated by PGGANs.

![alt text](<Figures/Classification_boxplots.png>)
![alt text](<Figures/Classification_boxplots_F1.png>)

## 10. FAQ and Citation Guidelines
...
- **For any questions or issues**, feel free to reach out via email:
  ...
  - Ali S. Abosinnee: [abosinnee.ali@inf.elte.hu](abosinnee.ali@inf.elte.hu)
